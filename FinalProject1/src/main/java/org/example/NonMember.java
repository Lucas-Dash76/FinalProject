...
public class NonMember extends User implements Borrowable{
    private List<Item> rentedItems;

    public NonMember(List<Item> rentedItems) {
        this.rentedItems = new ArrayList<>();
    }

    public NonMember(String name, int id, Gender gender, List<Item> rentedItems) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(rentedItems, nonMember.rentedItems);
    }
